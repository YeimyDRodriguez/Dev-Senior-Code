...
import com.plataforma.excepcion.EstudianteNoEncontrado;
...
public class InscripcionService {
    ...
    public List<Inscripcion> listarInscripciones(){
     ...
     public List<Inscripcion> ListarInscripcionesPorEstudiante(Estudiante estudiante) throws EstudianteNoEncontrado{
            List<Inscripcion> resultado = new ArrayList<>();
            for(Inscripcion inscripcion : inscripciones){
                if(inscripcion.getEstudiante().getId() == estudiante.getId()){
            ...
            if(resultado.size() == 0){
                ...
                throw  new EstudianteNoEncontrado("Estudiante no relacionado a inscripciones");
            }
